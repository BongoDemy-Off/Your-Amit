    ...
    <div className="container mx-auto px-4">
      ...
      <div className="text-center max-w-4xl mx-auto mb-16">
        ...
        <p className="text-lg text-gray-600 leading-relaxed">
          অনিন্দ্য ইসলাম অমিতের নেতৃত্বে জেলা বিএনপি একটি আধুনিক, গণতান্ত্রিক এবং বৈষম্যহীন যশোর গড়ার লক্ষ্যে কাজ করছে। আমাদের রাজনীতি ক্ষমতার জন্য নয়, মানুষের অধিকার আদায়ের জন্য।
        </p>
      </div>
